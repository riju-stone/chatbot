...
name_search_query = ["who is", "who was", "where is"]
time_query = ["what is the time", "what is the date", "what is the date today"]
joke_query = ["tell me a joke", "tell me another joke"]
eval_query = ["solve expression",
              "evaluate expression", "calculate expression"]
youtube_query = ["play song", "play video"]
